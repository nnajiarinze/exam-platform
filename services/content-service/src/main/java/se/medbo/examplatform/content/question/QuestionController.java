...
final class QuestionController {
    ...
    record ActionRequest(@NotNull @PositiveOrZero Long version,String reason,String reasonCode){QuestionService.ActionInput input(){return new QuestionService.ActionInput(version,reason,reasonCode);}}
