...
final class ReleaseController {
    ...
    record ReleaseRequest(@NotNull UUID examVersionId,@NotBlank String releaseNumber,@NotBlank String displayName,String description,String releaseType,String approvalStrategy,String disclaimer,String attribution,Long version){ReleaseService.ReleaseInput input(){return new ReleaseService.ReleaseInput(examVersionId,releaseNumber,displayName,description,releaseType==null?"PUBLIC":releaseType,approvalStrategy==null?"MANUAL_REVIEW":approvalStrategy,disclaimer,attribution,version);}}
