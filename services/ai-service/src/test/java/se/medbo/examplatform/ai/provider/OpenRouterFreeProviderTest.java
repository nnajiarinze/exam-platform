...
class OpenRouterFreeProviderTest {
  ...
  @Test void rejectsNonZeroAndUnknownPricing()throws Exception{assertThat(provider.zeroPricing(mapper.readTree("{\"prompt\":\"0.0001\",\"completion\":\"0\",\"request\":\"0\",\"internal_reasoning\":\"0\",\"input_cache_read\":\"0\",\"input_cache_write\":\"0\"}"))).isFalse();assertThat(provider.zeroPricing(mapper.readTree("{\"prompt\":\"0\"}"))).isFalse();}
}
