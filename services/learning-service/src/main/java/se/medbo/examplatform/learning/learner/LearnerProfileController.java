...
public class LearnerProfileController {
    ...
    @DeleteMapping public void delete(@RequestHeader(value="X-Learner-Identity",required=false)String developmentIdentity){
        identity.resolve(developmentIdentity);
        throw new se.medbo.examplatform.learning.shared.ApiException(HttpStatus.CONFLICT,"SECURE_DELETION_CONFIRMATION_REQUIRED","Use the identity deletion confirmation flow");
    }
