...
type Readiness = { issuer: string; mobileCallback: string; bffReady: boolean; accountDeletionEnabled: boolean; email: { enabled: boolean; verificationRequired: boolean; smtpConfigured: boolean }; providers: ProviderState[]; providerErrorCount24h: number; accountLinkingConflictCount24h: number; checkedAt: string };
