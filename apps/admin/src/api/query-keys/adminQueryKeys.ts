export const adminQueryKeys={
 ...
 ,ai:{job:(id:string)=>['ai','jobs',id] as const,proposals:(id:string)=>['ai','jobs',id,'proposals'] as const,editorialJob:(factId:string,operation:string,id:string)=>['ai','editorial','facts',factId,'operations',operation,'jobs',id] as const,editorialProposals:(factId:string,operation:string,id:string)=>['ai','editorial','facts',factId,'operations',operation,'jobs',id,'proposals'] as const,editorialFindings:(factId:string,operation:string,id:string)=>['ai','editorial','facts',factId,'operations',operation,'jobs',id,'findings'] as const,providerStatus:['ai','provider','status'] as const,providerAlerts:['ai','provider','alerts'] as const}
};
