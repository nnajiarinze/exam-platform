...
const question = { sessionQuestionId: 'sq1', questionId: 'q1', prompt: 'Who makes Swedish laws?', questionType: 'SINGLE_CHOICE' as const, answerOptions: [{ id: 'a1', text: 'Riksdagen' }, { id: 'a2', text: 'Polisen' }], selectedOptionIds: [], sequenceNumber: 1, totalQuestionCount: 3 };
