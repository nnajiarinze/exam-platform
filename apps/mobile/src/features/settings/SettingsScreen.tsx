...
export function SettingsScreen({navigation}:NativeStackScreenProps<RootStackParamList,'Settings'>){
  ...
  return <View style={styles.page}><Screen bottomInset><AppHeader onBack={()=>navigation.navigate('Home')} action="help" onAction={()=>unavailable('Help Center')}/>
    ...
    <SettingsSection title="Account"><SettingsRow icon="person" label="Edit Profile" onPress={()=>navigation.navigate('EditProfile')}/><Divider/><SettingsRow icon="lock" label="Sign-in methods" detail="Password, Google and Apple" onPress={()=>navigation.navigate('LinkedLogins')}/><Divider/><SettingsRow icon="lock" label="Change Password" onPress={()=>navigation.navigate('ChangePassword')}/></SettingsSection>
    ...
    <SettingsSection title="Account management"><SettingsRow icon="delete" label="Delete Account" onPress={()=>navigation.navigate('DeleteAccount')}/></SettingsSection>
