...
/**
 * Review all or only incorrect questions after submission
 */
export const getMockExamQuestionReview = <ThrowOnError extends boolean = false>(options: Options<GetMockExamQuestionReviewData, ThrowOnError>): RequestResult<GetMockExamQuestionReviewResponses, GetMockExamQuestionReviewErrors, ThrowOnError> => (options.client ?? client).get<GetMockExamQuestionReviewResponses, GetMockExamQuestionReviewErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
