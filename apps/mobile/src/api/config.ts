...
export const appConfig = {
  ...
  oidcAudience: process.env.EXPO_PUBLIC_OIDC_AUDIENCE ?? 'learning-api',
  appleIdentityProvider: process.env.EXPO_PUBLIC_APPLE_IDP_ALIAS ?? 'apple',
  googleIdentityProvider: process.env.EXPO_PUBLIC_GOOGLE_IDP_ALIAS ?? 'google',
  appleSignInEnabled: process.env.EXPO_PUBLIC_APPLE_SIGN_IN_ENABLED === 'true',
  googleSignInEnabled: process.env.EXPO_PUBLIC_GOOGLE_SIGN_IN_ENABLED === 'true',
